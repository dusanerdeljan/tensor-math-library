...
int main()
{
	...
	std::cout << tml::eager::Max(m1, tml::execution::omp) << std::endl;
	std::cout << tml::eager::MaxRows(m1, tml::execution::omp) << std::endl;
	std::cout << tml::eager::MaxColumns(m1, tml::execution::omp) << std::endl;
	std::cin.get();
	return 0;
}

...
{
	TestProfile();
	tml::Matrix<double> m1 = tml::Matrix<double>::Arange(4, 4);
	tml::Matrix<int> m2 = tml::Matrix<int>::Arange(4, 4);
	tml::Matrix<int> m3 = tml::Matrix<int>::Arange(4, 4);
	std::cout << m1 << std::endl;
	std::cout << tml::eager::Mean(m1, tml::execution::seq) << std::endl;
	std::cout << tml::eager::MeanRows(m1, tml::execution::seq) << std::endl;
	std::cout << tml::eager::MeanColumns(m1, tml::execution::seq) << std::endl;
	std::cin.get();
	return 0;
}

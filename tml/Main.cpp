...
void TestProfile()
{
	...
	auto result = tml::eager::GraterThan(m1, m2, tml::execution::omp);
	...
	auto r2 = tml::eager::GraterThan(m2, m1, tml::execution::stl);
...
int main()
{
	...
	std::cout << tml::eager::Add(m1, m2, tml::execution::seq) << std::endl;
	std::cout << tml::eager::Add(m1, m2, tml::execution::stl) << std::endl;

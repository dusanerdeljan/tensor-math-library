...
void TestProfile()
{
	...
	auto result = tml::eager::Matmul(m1, m2, tml::execution::seq);
	...
	auto r2 = tml::eager::Matmul(m1, m2, tml::execution::stl);
...
int main()
{
	...
	std::cout << tml::eager::Matmul(m1, m2, tml::execution::stl) << std::endl;

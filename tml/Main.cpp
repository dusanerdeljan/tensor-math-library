...
int main()
{
	...
	std::cout << tml::eager::Argmin(m1, tml::execution::omp) << std::endl;
	std::cout << tml::eager::ArgminRows(m1, tml::execution::omp) << std::endl;
	std::cout << tml::eager::ArgminColumns(m1, tml::execution::omp) << std::endl;
	std::cin.get();
	return 0;
}

...
int main()
{
	...
	std::cout << tml::eager::Min(m1, tml::execution::seq) << std::endl;
	std::cout << tml::eager::MinRows(m1, tml::execution::seq) << std::endl;
	std::cout << tml::eager::MinColumns(m1, tml::execution::seq) << std::endl;
	std::cin.get();
	return 0;
}

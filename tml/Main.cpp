...
int main()
{
	...
	std::cout << tml::eager::Mean(m1, tml::execution::omp) << std::endl;
	std::cout << tml::eager::MeanRows(m1, tml::execution::omp) << std::endl;
	std::cout << tml::eager::MeanColumns(m1, tml::execution::omp) << std::endl;
	std::cin.get();
	return 0;
}

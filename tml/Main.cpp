...
void TestProfile()
{
	...
	auto r2 = tml::eager::Transpose(m2, tml::execution::stl);
...
int main()
{
	...
	std::cout << tml::eager::Transpose(m1, tml::execution::seq) << std::endl;
	std::cout << tml::eager::Transpose(m2, tml::execution::stl) << std::endl;

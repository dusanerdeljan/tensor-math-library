...
int main()
{
	...
	std::cout << tml::eager::Transpose(m1) << std::endl;
	std::cout << tml::eager::Transpose(m2, tml::execution::tbb) << std::endl;
	std::cout << tml::eager::Transpose(m3, tml::execution::omp) << std::endl;
	std::cin.get();
	return 0;
}
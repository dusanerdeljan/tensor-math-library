...
namespace tml
{
	namespace eager
	{
		...
		TML_INLINE tml::matrix<Scalar> maximum(const tml::matrix<Scalar>& left, const expr_op<Scalar, T>& rightExpr, Backend backend = tml::execution::seq)
		{
		...
		template<typename Scalar, typename T, typename Backend = details::SEQ>
		TML_INLINE tml::matrix<Scalar> maximum(const expr_op<Scalar, T>& leftExpr, const tml::matrix<Scalar>& right, Backend backend = tml::execution::seq)
		{
		...
		TML_INLINE tml::matrix<Scalar> maximum(const expr_op<Scalar, Left>& leftExpr, const expr_op<Scalar, Right>& rightExpr, Backend backend = tml::execution::seq)
		{
		...
		template<typename Scalar, typename T, typename Backend = details::SEQ>
		TML_INLINE tml::matrix<Scalar> maximum(const expr_op<Scalar, T>& leftExpr, Scalar right, Backend backend = tml::execution::seq)
		{
			tml::matrix<Scalar> left = leftExpr;
			tml::matrix<Scalar> result(leftExpr.shape);
			details::backend::binary_op_backend<Scalar, Backend>::do_op(left, right, result, [](Scalar x, Scalar y) { return std::max<Scalar>(x, y); });
		...
		template<typename Scalar, typename T, typename Backend = details::SEQ>
		TML_INLINE tml::matrix<Scalar> maximum(Scalar left, const expr_op<Scalar, T>& rightExpr, Backend backend = tml::execution::seq)
		{
			tml::matrix<Scalar> right = rightExpr;
			tml::matrix<Scalar> result(rightExpr.shape);
			details::backend::binary_op_backend<Scalar, Backend>::do_op(left, right, result, [](Scalar x, Scalar y) { return std::max<Scalar>(x, y); });

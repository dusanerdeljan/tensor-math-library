...
namespace tml
{
	namespace eager
	{
		...
		TML_INLINE Scalar max(const expr_op<Scalar, T>& expr, Backend backend = tml::execution::seq)
		{
		...
		template<typename Scalar, typename Backend = details::SEQ>
		TML_INLINE tml::matrix<Scalar> max_rows(const tml::matrix<Scalar>& matrix, Backend backend = tml::execution::seq)
		{
		...
		template<typename Scalar, typename T, typename Backend = details::SEQ>
		TML_INLINE tml::matrix<Scalar> max_rows(const expr_op<Scalar, T>& expr, Backend backend = tml::execution::seq)
		{
		...
		template<typename Scalar, typename Backend = details::SEQ>
		TML_INLINE tml::matrix<Scalar> max_columns(const tml::matrix<Scalar>& matrix, Backend backend = tml::execution::seq)
		{
		...
		template<typename Scalar, typename T, typename Backend = details::SEQ>
		TML_INLINE tml::matrix<Scalar> max_columns(const expr_op<Scalar, T>& expr, Backend backend = tml::execution::seq)
		{

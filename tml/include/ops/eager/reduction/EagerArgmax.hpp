...
namespace tml
{
	namespace eager
	{
		...
		TML_INLINE Scalar argmax(const tml::matrix<Scalar>& matrix, Backend = tml::execution::seq)
		{
			Scalar result;
		...
		TML_INLINE Scalar argmax(const expr_op<Scalar, T>& expr, Backend = tml::execution::seq)
		{
		...
		template<typename Scalar, typename Backend = details::SEQ>
		TML_INLINE tml::matrix<Scalar> argmax_rows(const tml::matrix<Scalar>& matrix, Backend = tml::execution::seq)
		{
		...
		template<typename Scalar, typename T, typename Backend = details::SEQ>
		TML_INLINE tml::matrix<Scalar> argmax_rows(const expr_op<Scalar, T>& expr, Backend = tml::execution::seq)
		{
		...
		template<typename Scalar, typename Backend = details::SEQ>
		TML_INLINE tml::matrix<Scalar> argmax_columns(const tml::matrix<Scalar>& matrix, Backend = tml::execution::seq)
		{
		...
		template<typename Scalar, typename T, typename Backend = details::SEQ>
		TML_INLINE tml::matrix<Scalar> argmax_columns(const expr_op<Scalar, T>& expr, Backend = tml::execution::seq)
		{

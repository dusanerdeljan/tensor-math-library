...
operator + (const tml::Matrix<Scalar>& left, const tml::Matrix<Scalar>& right)
{
	...
	return ExprOP<Scalar, ExprType>(ExprType(left.cbegin(), right.cbegin()));
}
...
operator + (const tml::Matrix<Scalar>& left, const ExprOP<Scalar, T>& right)
{
	...
	return ExprOP<Scalar, ExprType>(ExprType(left.cbegin(), right));
}
...
operator + (const ExprOP<Scalar, T>& left, const tml::Matrix<Scalar>& right)
{
	...
	return ExprOP<Scalar, ExprType>(ExprType(left, right.cbegin()));
}
...
operator + (const ExprOP<Scalar, Left>& left, const ExprOP<Scalar, Right>& right)
{
	...
	return ExprOP<Scalar, ExprType>(ExprType(left, right));
}
...
operator +(Scalar right, const ExprOP<T, Scalar>& left)
{
